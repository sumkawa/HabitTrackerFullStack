...
import styles from './AllHabitsEditButton.module.css';
...
function AllHabitsEditHabitButton({ editOpen, setEditOpen, habit, user }) {
  ...
  const { tags } = React.useContext(AllHabitContext);
...
export default AllHabitsEditHabitButton;
